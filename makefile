...
bin/main: src/main.cpp bin/imgui.a bin/tree.o bin/octree.o bin/boundingbox.o bin/shapes.o bin/helper.o bin/interface.o bin/csgtree.o
	$(CC) $(CFLAGS) bin/interface.o bin/tree.o bin/octree.o bin/boundingbox.o bin/shapes.o bin/helper.o bin/csgtree.o src/main.cpp -o bin/main $(LINK)
